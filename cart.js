    ...
    checkout(){
        ...
        Object.keys(this.items).forEach(key => {
            ...
            if (this.items[key].amount >= promotion.skus.length) {
                console.log("PROMOTION! %d of %s for %d", promotion.skus.length, promotion.skus[0], promotion.price)
        ...
        multiSkuPromotions.forEach(promotion=> {
            ...
            if (foundAllSku){
                console.log("PROMOTION! %s for %d", promotion.skus.join("+"), promotion.price)
                promotion.skus.forEach(sku => {
